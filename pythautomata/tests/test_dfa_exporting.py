...
from pythautomata.model_exporters.image_exporters.dfa_pdf_image_exporting_strategy import DfaPdfExportingStrategy
...
class TestDFAExporting(TestCase):
    ...
    def test_1(self):
        ...
        DfaPdfExportingStrategy().export(dfa, "./output_models/tests")
