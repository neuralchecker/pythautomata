...
from automata_definitions.tomitas_grammars import TomitasGrammars
from automata_definitions.omlin_giles_automata import OmlinGilesAutomata
from automata_definitions.bollig_habermehl_kern_leucker_automata import BolligHabermehlKernLeuckerAutomata
