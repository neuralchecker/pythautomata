...
class FiniteAutomataComparator(ABC):
    ...
    @abstractmethod
    def are_equivalent(self, model1: 'pythautomata.abstract.finite_automaton.FiniteAutomaton', model2: 'pythautomata.abstract.finite_automaton.FiniteAutomaton') -> bool:
        # Returns true if both models are equivalent (i.e. they recongize the same
        # set of symbol sequences).
        raise NotImplementedError

    @abstractmethod
    def get_counterexample_between(self, model1: 'pythautomata.abstract.finite_automaton.FiniteAutomaton', model2: 'pythautomata.abstract.finite_automaton.FiniteAutomaton') -> Sequence:
