...
class WeightedTomitasGrammarsWithZeroTransitions:
    """
    ...
    Some weights here are modified to be zero (0)
    ...
    get_automaton_1: ProbabilisticDeterministicFiniteAutomaton
        returns a variation with a zero transition of the weighted automaton 1 from the paper

    get_automaton_2: ProbabilisticDeterministicFiniteAutomaton
        returns a variation with a zero transition of the weighted automaton 2 from the paper

    get_automaton_3: ProbabilisticDeterministicFiniteAutomaton
        returns a variation with a zero transition of the weighted automaton 3 from the paper

    get_automaton_4: ProbabilisticDeterministicFiniteAutomaton
        returns a variation with a zero transition of the weighted automaton 4 from the paper

    get_automaton_5: ProbabilisticDeterministicFiniteAutomaton
        returns a variation with a zero transition of the weighted automaton 5 from the paper

    get_automaton_6: ProbabilisticDeterministicFiniteAutomaton
        returns a variation with a zero transition of the weighted automaton 6 from the paper

    get_automaton_7: ProbabilisticDeterministicFiniteAutomaton
        returns a variation with a zero transition of the weighted automaton 7 from the paper
    """
    ...
    def get_all_automata():
        ...
        """
        return [
            WeightedTomitasGrammarsWithZeroTransitions.get_automaton_1(),
            WeightedTomitasGrammarsWithZeroTransitions.get_automaton_2(),
            WeightedTomitasGrammarsWithZeroTransitions.get_automaton_3(),
            WeightedTomitasGrammarsWithZeroTransitions.get_automaton_4(),
            WeightedTomitasGrammarsWithZeroTransitions.get_automaton_5(),
            WeightedTomitasGrammarsWithZeroTransitions.get_automaton_6(),
            WeightedTomitasGrammarsWithZeroTransitions.get_automaton_7()
        ]
    ...
    def get_automaton_2():
        ...
        q1.add_transition(zero, q0, 0)
        q1.add_transition(one, q2, 0.95)
    ...
    def get_automaton_3():
        ...
        q0.add_transition(zero, q0, 0)
        q0.add_transition(one, q1, 0.95)
        ...
        q3.add_transition(zero, q2, 0)
        q3.add_transition(one, q3, 0.95)
    ...
    def get_automaton_4():
        ...
        q1.add_transition(zero, q2, 0)
        q1.add_transition(one, q0, 0.95)
    ...
    def get_automaton_7():
        ...
        q2.add_transition(zero, q2, 0.0)
        q2.add_transition(one, q3, 0.95)
